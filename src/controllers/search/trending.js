...
const {
  findTrendingReplies, findTrendingStories 
} = require('../../queries').storyQueries.searchQueries;
...
*/
const treandingReplies = async(req, res, next) => {
  // get page from the query
  let page = req.query.page || 1;
...
module.exports = {
  trendingStories, treandingReplies
}